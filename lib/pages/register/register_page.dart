                  ...
                  child: Column(
                    children: [
                      ...
                      DropdownButtonFormField<UserType>(
                        ...
                        items: UserType.values.map((UserType type) => DropdownMenuItem<UserType>(value: type, child: Text(type.name.tr()))).toList(),
                        decoration: InputDecoration(
                            enabled: !state.isLoading,
                            labelText: LocaleKeys.userType.tr(),
                            hintText: LocaleKeys.selectUserType.tr(),
                            alignLabelWithHint: true),
                        onChanged: (UserType? newValue) => setState(() => _selectedUserType = newValue),
                        validator: (value) {
                          if (value == null) return LocaleKeys.pleaseSelectUserType.tr();
                          return null;
                        },
                      ),
                      const SizedBox(height: 12.0),
