...
mixin _$AuthEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(auth.User? user) userChanged,
    required TResult Function() logout,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(auth.User? user)? userChanged,
...
abstract class _UserChanged implements AuthEvent {
  const factory _UserChanged({final auth.User? user}) = _$UserChangedImpl;
...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthStatus status, auth.User? user});
}
...
abstract class _AuthState implements AuthState {
  const factory _AuthState(
      ...
      final auth.User? user}) = _$AuthStateImpl;
